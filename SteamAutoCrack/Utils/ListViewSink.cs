        ...
        Application.Current.Dispatcher.Invoke((Action)(() =>
        {
            if (logEvent.RenderMessage() != string.Empty)
            {
                ...
                var listviewitem = new ListViewItem
                    { Content = item, Background = logColor, Foreground = Brushes.Black };
            ...
            if (logEvent.Exception != null)
            {
                ...
                var listviewitemex = new ListViewItem
                    { Content = itemex, Background = logColor, Foreground = Brushes.Black };
