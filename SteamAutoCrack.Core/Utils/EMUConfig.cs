...
public class EMUConfigGenerator : IEMUConfigGenerator
{
    ...
    public bool Generate(EMUConfig EMUConfig)
    {
        try
        {
            ...
            {
                new Property("account_name",
                    EMUConfig.AccountName == "" ? EMUConfig.DefaultConfig.AccountName : EMUConfig.AccountName,
                    " user account name", " default=gse orca"),
                new Property("account_steamid", EMUConfig.SteamID.ConvertToUInt64().ToString(),
            ...
            if (EMUConfig.Ticket != EMUConfig.DefaultConfig.Ticket)
                ...
                configsuser["user::general"].Add(new Property("ticket", EMUConfig.Ticket,
                    " the encrypted application ticket in base64 format",
                    " default=none"));

            configsmain.Add(new Section("main::connectivity")
                {
                    new Property("disable_networking", EMUConfig.DisableNetworking,
                        ...
                        " default=0"),
                    new Property("listen_port", EMUConfig.ListenPort.ToString(),
            ...
            {
                new Property("enable_experimental_overlay", EMUConfig.EnableOverlay,
